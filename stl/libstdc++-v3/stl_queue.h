...
namespace std _GLIBCXX_VISIBILITY(default)
{
  ...
  */
      ...
      public:
            ...
            explicit queue(const _Sequence &__c)
                : c(__c) {}

            explicit queue(_Sequence &&__c)
                : c(std::move(__c)) {}
             ...
             *  underlying sequence.
             * 
             *  Because @a queue is just an adaptor, this function use the underlying
             *  container with default to std::vector, and can also use std::deque.
             */
            void
       ...
       *  @return  True iff(if and only if) the size and elements of the queues are equal.
       *
