...
namespace std _GLIBCXX_VISIBILITY(default)
{
  ...
  using __cache_default = __not_<__and_< // Do not cache for fast hasher.
  ...
  private:
    ...
    _Hashtable(_Hashtable &&__ht, __node_alloc_type &&__a,
               true_type /* alloc always equal */) noexcept(std::is_nothrow_copy_constructible<_H1>::value &&
  ...
  public:
    ...
    _Hashtable(_Hashtable &&__ht) noexcept(noexcept(
    ...
    _Hashtable(_Hashtable &&__ht, const allocator_type &__a) noexcept(noexcept(
        _Hashtable(std::declval<_Hashtable>(),
                   std::declval<__node_alloc_type>(),
    ...
    explicit _Hashtable(size_type __bkt_count_hint,
                        const _H1 &__hf = _H1(),
    ...
    _Hashtable &
    operator=(_Hashtable &&__ht) noexcept(__node_alloc_traits::_S_nothrow_move() && is_nothrow_move_assignable<_H1>::value && is_nothrow_move_assignable<_Equal>::value)
    {
    ...
    void
    swap(_Hashtable &) noexcept(__and_<__is_nothrow_swappable<_H1>,
  ...
  public:
    ...
    _M_reinsert_node(node_type &&__nh)
    {
      ...
      else
      {
        ...
        {
          __ret.position = _M_insert_unique_node(__k, __bkt, __code, __nh._M_ptr);
          __nh._M_ptr = nullptr;
          __ret.inserted = true;
        }
      }
    ...
    _M_reinsert_node_multi(const_iterator __hint, node_type &&__nh)
    {
      ...
      auto __ret = _M_insert_multi_node(__hint._M_cur, __k, __code, __nh._M_ptr);
      __nh._M_ptr = nullptr;
      return __ret;
    }
      ...
      _M_assign(_Ht && __ht, const _NodeGenerator &__node_gen)
  {
    ...
    __try
    {
      ...
      __node_type *__this_n = __node_gen(__fwd_value_for<_Ht>(__ht_n->_M_v()));
        ...
        _M_rehash_policy(__ht._M_rehash_policy)
  {
    ...
    else
    {
      ...
      using _Fwd_Ht = typename conditional<__move_if_noexcept_cond<value_type>::value,
  ...
  void
      _Hashtable<_Key, _Value, _Alloc, _ExtractKey, _Equal,
                 _H1, _H2, _Hash, _RehashPolicy, _Traits>::
          swap(_Hashtable & __x) noexcept(__and_<__is_nothrow_swappable<_H1>,
                                                 __is_nothrow_swappable<_Equal>>::value)
  {
          ...
          ->iterator
  {
    ...
    __hash_code __code = this->_M_hash_code(__k);
    auto __pos = _M_insert_multi_node(__hint._M_cur, __k, __code, __node._M_node);
    __node._M_node = nullptr;
    return __pos;
  }
  ...
  {
    const __rehash_state &__saved_state = _M_rehash_policy._M_state();
    __bkt_count = std::max(_M_rehash_policy._M_bkt_for_elements(_M_element_count + 1),
                           __bkt_count);
    ...
    while (__p)
    {
      ...
      else
      {
        if (__check_bucket)
        {
          ...
          if (__prev_p->_M_nxt)
          {
            std::size_t __next_bkt = __hash_code_base::_M_bucket_index(__prev_p->_M_next(),
                                                                       __bkt_count);
