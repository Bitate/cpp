...
#pragma GCC diagnostic pop
  ...
  class unique_ptr<_Tp[], _Dp>
  {
    ...
    template <typename _Up>
    using __is_derived_Tp = __and_<is_base_of<_Tp, _Up>,
  ...
  public:
    ...
    explicit unique_ptr(_Up __p) noexcept
        : _M_t(__p)
    {
    }
  ...
  requires three_way_comparable_with<typename unique_ptr<_Tp, _Dp>::pointer,
                                     typename unique_ptr<_Up, _Ep>::pointer> inline compare_three_way_result_t<typename unique_ptr<_Tp, _Dp>::pointer,
  ...
  template <typename _Tp, typename _Dp>
  requires three_way_comparable<typename unique_ptr<_Tp, _Dp>::pointer> inline compare_three_way_result_t<typename unique_ptr<_Tp, _Dp>::pointer>
  operator<=>(const unique_ptr<_Tp, _Dp> &__x, nullptr_t)
  {
...
#define __cpp_lib_make_unique 201304
  ...
  operator<<(basic_ostream<_CharT, _Traits> &__os,
             const unique_ptr<_Tp, _Dp> &__p) requires requires { __os << __p.get(); }
  {
    __os << __p.get();
    return __os;
  }
