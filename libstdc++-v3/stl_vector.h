...
namespace std _GLIBCXX_VISIBILITY(default)
{
      ...
      struct _Vector_base
      {
            typedef typename construct::__alloc_traits<_Alloc>::template rebind<_Tp>::other _Tp_alloc_type;
            
            /**
             * __gnu_cxx?
             * 
             * __gnu_cxx is a namespace, not class.
             */
...
#define _GLIBCXX_ASAN_ANNOTATE_BEFORE_DEALLOC
  ...
  */
      ...
      public:
            ...
            vector(vector &&__rv, const allocator_type &__m) noexcept(noexcept(
