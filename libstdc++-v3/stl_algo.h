...
namespace std _GLIBCXX_VISIBILITY(default)
{
                 ...
                 _BinaryPredicate __comp)
  {
    ...
    __glibcxx_function_requires(_BidirectionalIteratorConcept<
        ...
        __glibcxx_function_requires(_BidirectionalIteratorConcept<
            ...
            typedef reverse_iterator<_BidirectionalIterator1>
                _RevIterator1;
  ...
  */
  template <typename _ForwardIterator1, typename _ForwardIterator2>
  _GLIBCXX20_CONSTEXPR inline _ForwardIterator1
  ...
  */
                    ...
                    input_iterator_tag, output_iterator_tag)
  {
    ...
    __decltype(__gnu_cxx::__ops::__iter_comp_val(__binary_pred))
        __rebound_pred = __gnu_cxx::__ops::__iter_comp_val(__binary_pred);
    *__result = __value;
    while (++__first != __last)
  ...
  */
  ...
  /**
   * @brief  Sort is a combination of quick-socr, heap-sort and insertion-sort.
   * 
  ...
  */
  template <typename _ForwardIterator, typename _Tp>
  _GLIBCXX20_CONSTEXPR inline pair<_ForwardIterator, _ForwardIterator>
  ...
  */
                   ...
                   _Compare __comp)
  {
    ...
    else
    {
      ...
      _BidirectionalIterator __new_middle = std::__rotate_adaptive(__first_cut, __middle, __second_cut,
                  ...
                  _Compare __comp)
  {
    ...
    if (__buf.begin() == 0)
      ...
      std::__merge_adaptive(__first, __middle, __last, __len1, __len2, __buf.begin(),
  ...
  */
  ...
  _GLIBCXX14_CONSTEXPR inline pair<const _Tp &, const _Tp &>
  ...
  */
  template <typename _ForwardIterator>
  _GLIBCXX14_CONSTEXPR inline pair<_ForwardIterator, _ForwardIterator>
  ...
  */
  ...
  // N2722 + DR 915.
  template <typename _Tp>
  _GLIBCXX14_CONSTEXPR inline _Tp
  ...
  template <typename _Tp>
  _GLIBCXX14_CONSTEXPR inline pair<_Tp, _Tp>
...
#define __cpp_lib_clamp 201603
  ...
  */
  template <typename _ForwardIterator>
  _GLIBCXX14_CONSTEXPR
      _ForwardIterator inline min_element(_ForwardIterator __first, _ForwardIterator __last)
  {
    // concept requirements
    __glibcxx_function_requires(_ForwardIteratorConcept<_ForwardIterator>)
        __glibcxx_function_requires(_LessThanComparableConcept<
  ...
  */
  template <typename _ForwardIterator, typename _Compare>
  _GLIBCXX14_CONSTEXPR inline _ForwardIterator
