...
#undef _GLIBCXX20_INIT
  ...
  struct __atomic_ref<_Tp, false, false>
  {
    ...
    static constexpr int _S_min_alignment = (sizeof(_Tp) & (sizeof(_Tp) - 1)) || sizeof(_Tp) > 16
                                                ? 0
                                                : sizeof(_Tp);
  ...
  public:
    ...
    static constexpr size_t required_alignment = _S_min_alignment > alignof(_Tp) ? _S_min_alignment : alignof(_Tp);
  ...
  public:
    ...
    static constexpr size_t required_alignment = sizeof(_Tp) > alignof(_Tp) ? sizeof(_Tp) : alignof(_Tp);
